...
export class App {
  ...
  private setupSearchModal(): void {
    const searchOptions = { placeholder: 'Haber, boru hattı, üs, piyasa ara...' };
    ...
    this.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          <img src="${import.meta.env.BASE_URL}logo_00000.png" alt="Logo" style="height:32px;width:auto;margin-right:8px;display:block;" />
  ...
  private setupEventListeners(): void {
    ...
    // Variant switcher: disabled (Turkey-only, single variant)
    // if (this.isDesktopApp) { ... }
  ...
  private async loadTechEvents(): Promise<void> {
    console.log('[loadTechEvents] Called. techEvents layer:', this.mapLayers.techEvents);
    // Only load if techEvents layer is enabled
    if (!this.mapLayers.techEvents) {
      console.log('[loadTechEvents] Skipping - techEvents layer disabled');
      return;
    }
